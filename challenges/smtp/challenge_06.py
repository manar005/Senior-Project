...
challenge = {
    ...
    'description': 'Identify the application layer protocol used in this communication. The traffic you need uses port 2525. The flag is the protocol name in uppercase.',
