"""
One-off script for Challenge 6 pcap. Runs a minimal SMTP server and a client that
performs a short SMTP dialog (HELO, QUIT). Flag = SMTP (protocol identification).

Run while capturing on loopback in Wireshark; save as static/pcaps/challenge_06.pcapng.
